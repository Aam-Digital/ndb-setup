...
1. Enable the reporting backend:
    ...
    - add an `application.env` for the backend (`config/aam-backend-service/application.env`) --> see TODO [https://github.com/Aam-Digital/aam-services/blob/main/docs/modules/reporting.md]
